...
public class VOCABOOK_HANJA_CLASSICS extends RealmObject {

    @PrimaryKey
    private Long ID;
    private Long VOCABOOKS_ID;
    private Long VOCA_ID;
    private Long USE_VOCABOOK_DATA;
    private String VOCA;
    private Long USED;
    ...
    public Long getVOCABOOKS_ID() {
        return VOCABOOKS_ID;
    }

    public void setVOCABOOKS_ID(Long VOCABOOKS_ID) {
    ...
    public Long getUSE_VOCABOOK_DATA() {
        return USE_VOCABOOK_DATA;
    }

    public void setUSE_VOCABOOK_DATA(Long USE_VOCABOOK_DATA) {
        this.USE_VOCABOOK_DATA = USE_VOCABOOK_DATA;
    }
