...
import com.dalread.databinding.FragmentMainMenuHangulBinding;
...
public class MenuFragmentMainHangul extends BaseConvFragment {
    ...
    private FragmentMainMenuHangulBinding binding;

    @Override
    protected View getContentView() {
        binding = FragmentMainMenuHangulBinding.inflate(getLayoutInflater());
    ...
    private void initData() {
        ...
        parentBook = null; //(VocaBook) getArguments().getSerializable(Constant.BUNDLE.KEY_VOCA_BOOK);
        getData();
        bindData();
    }
    ...
    private void getData() {
        if (parentBook == null) {
            vocaBookList = activity.subDatabase.getServerVocaBookListByCategoryForHangulWriting();
...
//                bindData();
    ...
    private void openVocaListView(VocaBook vocaBook) {
        openNewScreen(
                ConvVocaListActivity.createIntentByBookId(activity, Integer.parseInt(String.valueOf(vocaBook.getIBookId())), false)
        );
    }
