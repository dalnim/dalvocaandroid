...
import com.dalread.databinding.FragmentHangulBinding;
...
public class MenuFragmentHangulWriting extends BaseConvFragment implements View.OnClickListener {
    private List<VocaBook> vocaBooks;
    private MainHomeActivity activity;
    private FragmentHangulBinding binding;

    @Override
    protected View getContentView() {
        binding = FragmentHangulBinding.inflate(getLayoutInflater());
...
//                openPracticeTypingScreen();
    ...
    private void openWordbookListScreenByBookId() {
        openNewScreen(
                WorkbookListToPracticeActivity.createIntent(activity)
        );
    }
