...
//    protected DicDatabase dicDatabase;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        clDivider = ContextCompat.getColor(this, R.color.color_divider);
        dividerHeight = this.getResources().getDimension(R.dimen.divider_height);
        initSubDatabase();
//        initDicDatabase();
...
//        dicDatabase = null;
//        String destPathWithFileName = BaseStorageUtil.getAraConvDBPathWithFileName(context);
//        dicDatabase = DicDatabase.getInstance(this, destPathWithFileName);
//    }
