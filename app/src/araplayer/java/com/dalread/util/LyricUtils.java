...
import com.dalread.model.Lyric.Sentence;
...
public class LyricUtils {
    ...
    private static boolean parseLine(String line, Lyric lyric) {
        ...
        while (openBracketIndex != -1) {
            ...
            if (colonSplited[0].equalsIgnoreCase(Constant.LYRIC.ID_TAG_TITLE)) {
                lyric.title = colonSplited[1].trim();
            } else if (colonSplited[0].equalsIgnoreCase(Constant.LYRIC.ID_TAG_TITLE_TTS)) {
                lyric.titleTts = colonSplited[1].trim();
            } else if (colonSplited[0].equalsIgnoreCase(Constant.LYRIC.ID_TAG_ARTIST)) {
                lyric.artist = colonSplited[1].trim();
            } else if (colonSplited[0].equalsIgnoreCase(Constant.LYRIC.ID_TAG_ARTIST_TTS)) {
                lyric.artistTts = colonSplited[1].trim();
            } else if (colonSplited[0].equalsIgnoreCase(Constant.LYRIC.ID_TAG_ALBUM)) {
                lyric.album = colonSplited[1].trim();
            } else if (colonSplited[0].equalsIgnoreCase(Constant.LYRIC.ID_TAG_CREATOR_LRCFILE)) {
                lyric.by = colonSplited[1].trim();
            } else if (colonSplited[0].equalsIgnoreCase(Constant.LYRIC.ID_TAG_CREATOR_SONGTEXT)) {
                lyric.author = colonSplited[1].trim();
            } else if (colonSplited[0].equalsIgnoreCase(Constant.LYRIC.ID_TAG_LENGTH)) {
                lyric.length = parseTime(colonSplited[1].trim(), lyric);
            } else if (colonSplited[0].equalsIgnoreCase(Constant.LYRIC.ID_TAG_OFFSET)) {
    ...
    public static String makeLrcHeaderByTag(String tag, String value) {
        return "[" + tag + ":" + value + "]";
    }
    ...
    public static String parseTextFromFile(File file, String Encoding) {
