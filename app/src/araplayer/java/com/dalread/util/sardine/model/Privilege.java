...
public class Privilege {
	...
	@ElementListUnion({
			...
			@ElementList(entry="read-acl", inline=true, type= com.dalread.util.sardine.model.ReadAcl.class),
			@ElementList(entry="write-acl", inline=true, type= com.dalread.util.sardine.model.WriteAcl.class),
