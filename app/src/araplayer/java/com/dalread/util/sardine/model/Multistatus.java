...
public class Multistatus {
    ...
    protected List<com.dalread.util.sardine.model.Response> response;
     ...
     * {@link com.dalread.util.sardine.model.Response }
     *
     *
     */
    public List<com.dalread.util.sardine.model.Response> getResponse() {
        if (response == null) {
