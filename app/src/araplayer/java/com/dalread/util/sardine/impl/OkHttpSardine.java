package com.dalread.util.sardine.impl;

import android.text.TextUtils;

import com.dalread.util.sardine.DavAce;
import com.dalread.util.sardine.DavAcl;
import com.dalread.util.sardine.DavPrincipal;
import com.dalread.util.sardine.DavQuota;
import com.dalread.util.sardine.DavResource;
import com.dalread.util.sardine.Sardine;
import com.dalread.util.sardine.impl.handler.ExistsResponseHandler;
import com.dalread.util.sardine.impl.handler.InputStreamResponseHandler;
import com.dalread.util.sardine.impl.handler.LockResponseHandler;
import com.dalread.util.sardine.impl.handler.MultiStatusResponseHandler;
import com.dalread.util.sardine.impl.handler.ResourcesResponseHandler;
import com.dalread.util.sardine.impl.handler.ResponseHandler;
import com.dalread.util.sardine.impl.handler.VoidResponseHandler;
import com.dalread.util.sardine.model.Ace;
import com.dalread.util.sardine.model.Acl;
import com.dalread.util.sardine.model.Allprop;
import com.dalread.util.sardine.model.Exclusive;
import com.dalread.util.sardine.model.Group;
import com.dalread.util.sardine.model.Lockinfo;
import com.dalread.util.sardine.model.Lockscope;
import com.dalread.util.sardine.model.Locktype;
import com.dalread.util.sardine.model.Multistatus;
import com.dalread.util.sardine.model.Owner;
import com.dalread.util.sardine.model.PrincipalCollectionSet;
import com.dalread.util.sardine.model.Prop;
import com.dalread.util.sardine.model.Propertyupdate;
import com.dalread.util.sardine.model.Propfind;
import com.dalread.util.sardine.model.Propstat;
import com.dalread.util.sardine.model.QuotaAvailableBytes;
import com.dalread.util.sardine.model.QuotaUsedBytes;
import com.dalread.util.sardine.model.Remove;
import com.dalread.util.sardine.model.SearchRequest;
import com.dalread.util.sardine.model.Set;
import com.dalread.util.sardine.model.Write;
import com.dalread.util.sardine.report.SardineReport;
...
//        prop.setGetetag(objectFactory.createGetetag());
    ...
    public DavAcl getAcl(String url) throws IOException {
        ...
        Multistatus multistatus = this.execute(request, new MultiStatusResponseHandler());
        List<com.dalread.util.sardine.model.Response> responses = multistatus.getResponse();
    ...
    public List<DavPrincipal> getPrincipals(String url) throws IOException {
        ...
        if (responses.isEmpty()) {
            ...
            for (com.dalread.util.sardine.model.Response r : responses) {
