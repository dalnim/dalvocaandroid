...
public class Propertyupdate {
    ...
    @ElementListUnion({
            @ElementList(entry = "remove", type = com.dalread.util.sardine.model.Remove.class, inline = true),
            @ElementList(entry = "set", type = com.dalread.util.sardine.model.Set.class, inline = true),
    })
