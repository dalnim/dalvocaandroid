...
import com.dalread.util.sardine.model.Response;
...
public class DavAcl {
     ...
     *
     */
    private List<com.dalread.util.sardine.DavAce> aces;
    ...
    public List<com.dalread.util.sardine.DavAce> getAces() {
        return aces;
    }
    ...
    private List<com.dalread.util.sardine.DavAce> getAces(Response response) {
        ArrayList<com.dalread.util.sardine.DavAce> result = new ArrayList<com.dalread.util.sardine.DavAce>();
        List<Propstat> list = response.getPropstat();
        if (list.isEmpty()) {
            return null;
        }
