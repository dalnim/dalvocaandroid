package com.dalread.util.sardine;
...
public interface Sardine
{
	 ...
	 */
	@Deprecated
	List<com.dalread.util.sardine.DavResource> getResources(String url) throws IOException;
	 ...
	 */
	List<com.dalread.util.sardine.DavResource> list(String url) throws IOException;
	 ...
	 * @throws IOException I/O error or HTTP response validation failure
	 */
	List<com.dalread.util.sardine.DavResource> list(String url, int depth) throws IOException;
	 ...
	 * @throws IOException I/O error or HTTP response validation failure
	 */
	List<com.dalread.util.sardine.DavResource> list(String url, int depth, Set<QName> props) throws IOException;
	 ...
	 * @throws IOException I/O error or HTTP response validation failure
	 */
	List<com.dalread.util.sardine.DavResource> list(String url, int depth, boolean allProp) throws IOException;
	 ...
	 * @throws IOException I/O error or HTTP response validation failure
	 */
	List<com.dalread.util.sardine.DavResource> propfind(String url, int depth, Set<QName> props) throws IOException;
	 ...
	 * @throws IOException I/O error or HTTP response validation failure.
	 */
	List<com.dalread.util.sardine.DavResource> search(String url, String language, String query) throws IOException;
	 ...
	 * @throws IOException I/O error or HTTP response validation failure
	 */
	List<com.dalread.util.sardine.DavResource> patch(String url, Map<QName, String> addProps) throws IOException;
	 ...
	 * @throws IOException I/O error or HTTP response validation failure
	 */
	List<com.dalread.util.sardine.DavResource> patch(String url, Map<QName, String> addProps, List<QName> removeProps) throws IOException;
