...
import com.dalread.databinding.ActivityPlayerDictationModeBinding;
import com.dalread.util.Constant;
import com.dalread.util.Utils;

public class DictationModeActivity extends BasePlayerActivity {
    private ActivityPlayerDictationModeBinding binding;

    @Override
    protected View getContentView() {
        binding = ActivityPlayerDictationModeBinding.inflate(getLayoutInflater());
...
//        return R.layout.activity_player_dictation_mode;
//    }
...
//        initPlayVocaHelper();
    ...
    private void openPlayerFragment() {
        ...
        Fragment fragment = new DictationModeFragment();
