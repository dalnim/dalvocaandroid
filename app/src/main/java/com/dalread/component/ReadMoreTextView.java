...
public class ReadMoreTextView extends AppCompatTextView implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private boolean enableTrimMode;
    ...
    public ReadMoreTextView(Context context, AttributeSet attrs) {
        ...
        this.textIsSelectable = typedArray.getBoolean(R.styleable.ReadMoreTextView_textIsSelectable, false);
        this.enableTrimMode = typedArray.getBoolean(R.styleable.ReadMoreTextView_enableTrimMode, true);
        typedArray.recycle();
    ...
    private CharSequence addClickableSpan(SpannableStringBuilder s, CharSequence trimText) {
        s.setSpan(new UnderlineSpan(), s.length() - trimText.length(), s.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    public void onGlobalLayout() {
        if (getLineCount() < 1 || !enableTrimMode) return;
        refreshLineEndIndex();
        setText();
    ...
    public void setEnableTrimMode(boolean enableTrimMode) {
        this.enableTrimMode = enableTrimMode;
    }
}
