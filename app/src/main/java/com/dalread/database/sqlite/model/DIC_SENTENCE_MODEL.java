...
public class DIC_SENTENCE_MODEL extends AbstractMeanings implements Serializable, IVocaFullPlayTTSItem {// IVocaFullItem, PlaylistItem {
    public int ID;
    public String WORD;
...
//    }
    ...
    public void setWORD_ID_LIST(String WORD_ID_LIST) {
        this.WORD_ID_LIST = WORD_ID_LIST;
    }
    ...
    public void setWORDORI_ID_LIST(String WORDORI_ID_LIST) {
        this.WORDORI_ID_LIST = WORDORI_ID_LIST;
    }
...
//        setVOCA_ID(value);
    ...
    public String getPersonAB() {
        return PERSON_AB != null ? PERSON_AB : "";
    }
