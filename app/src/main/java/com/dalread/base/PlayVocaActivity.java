...
public abstract class PlayVocaActivity extends VocaActivity
            ...
            application.getDalAiImpl().getMultipleVoiceFileVersion(
                    ...
                    new DalApiListener<List<VocaDownload>>() {
                        ...
                        public void onSuccess(final List<VocaDownload> response) {
                            ...
                            if (!Utils.hasWifiConnected(PlayVocaActivity.this) && downloadSize > Constant.DOWNLOAD_CONFIRM_SIZE) {
                                new ConfirmDownloadVoiceFileDialog(
                                        PlayVocaActivity.this,
    ...
    private void downloadFileFromFirebase() {
        if (isFinishing() || isDestroyed()) {
            ...
            if (onDownloadVocaFinishListener != null) {
                ...
                onDownloadVocaFinishListener = null;
            }
        }
    }
    ...
    public void prepareDownloadVoca(IVocaFullPlayTTSItem voca, OnDownloadVocaFinishListener onDownloadVocaFinishListener) {
        vocas = new ArrayList<>();
        vocas.add(voca);
