...
public class Time {
	...
	public static boolean isPassedByTime(long timeBefore, long timePassedMilliSecond) {
		return System.currentTimeMillis() > timeBefore + timePassedMilliSecond;
	}

	public static boolean isShowAdsAfterTimeSinceLastClick(long timeBefore, long timeToShowAdsAgain) {
		return isPassedByTime(timeBefore, timeToShowAdsAgain);
	}
