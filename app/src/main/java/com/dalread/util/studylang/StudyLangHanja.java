...
public class StudyLangHanja extends AbstractStudyLang {

    StudyLangHanja(Context context) {
        super(context);
    }

    @Override
    protected void initEnumLanguage() {
        enumStudyLanguage = EnumLanguage.HANJA;
    }
    @Override
    protected void getDefaultTtsSpeed() {
        this.ttsSpeedDefault = Constant.SETTINGS.SETTING_TTS_SPEED_HANJA;
    }
    ...
    public void setTTSSpeedInSetting(int value) {
        ...
        sharedPreferences.setSettingTTSSpeedHanja(value);
    }
    @Override
    public int getPauseTimeToRepeatTts() {
        return ENUM_PAUSE_TIME_TO_REPEAT_TTS.HANJA.milliTime();
    }

    @Override
    public List<String> splitSentence(String sentence) {
        return splitByCharacter(StringUtils.getOnlyHanja(sentence));
    }
}
