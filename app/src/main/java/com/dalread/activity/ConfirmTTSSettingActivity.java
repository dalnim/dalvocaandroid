 ...
 */
public class ConfirmTTSSettingActivity extends BaseActivityNoHeader implements BaseInit {
    ...
    public static Intent createIntent(Context context, BaseEvent.Screen screen) {
        Intent intent = new Intent(context, ConfirmTTSSettingActivity.class);
    ...
    public void initView() {
        setContentView(R.layout.activity_confirm_tts_setting);
    ...
    public void onClickBtnOpenSetting() {
        mApplication.getEventBus().post(new SuccessEvent(BaseEvent.Screen.DAL_READ, BaseEvent.EventType.CALL_BACK_TTS_SETTING, null));
        mApplication.getEventBus().post(new SuccessEvent(BaseEvent.Screen.WORD_LIST, BaseEvent.EventType.CALL_BACK_TTS_SETTING, null));
        mApplication.getEventBus().post(new SuccessEvent(BaseEvent.Screen.WORD, BaseEvent.EventType.CALL_BACK_TTS_SETTING, null));
        openTTSSetting();
        onBackPressed();
    }
