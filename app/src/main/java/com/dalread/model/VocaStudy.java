...
public class VocaStudy extends RealmObject implements IVocaFullPlayTTSItem {
    ...
    @SerializedName("SEND_DATE_TS")
    private long sendDateTS;
    ...
    public long getSendDateTS() {
        return sendDateTS;
    }

    public void setSendDateTS(long sendDateTS) {
        this.sendDateTS = sendDateTS;
    }
