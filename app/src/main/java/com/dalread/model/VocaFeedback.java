...
public class VocaFeedback extends RealmObject implements IVocaFullPlayTTSItem {
    ...
    private long feedbackDate; // TODO: @dalnim why don't we use new key with suffix _TS here?
...
//        }
    ...
    public String getStudentCheckDate() {
        return studentCheckDate;
    }

    public void setStudentCheckDate(String studentCheckDate) {
        this.studentCheckDate = studentCheckDate;
    }
