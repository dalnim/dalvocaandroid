...
public class NativeSpeakersVoiceAdapter extends RecyclerView.Adapter {
    ...
    public static class ItemHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(SharedPreferencesDB sharedPreferences, IVocaFullPlayTTSItem playlistItem, OnPlaylistItemClickListener listener) {
            ...
            String text = BaseVoca.getUserDisplayName(sharedPreferences, item);
            tvName.setText(text);
            text = BaseVoca.getUserDisplayLocation(itemView.getContext(), item);
            tvNation.setText(text);
//            Voca.updateIconSpeaker(icPlay, item);
            icAvatar.setImageResource(BaseVoca.getAvatarResource(item.getSex(), item.getAge()));
        }
        ...
        private void openOtherUserProfileScreen() {
            ...
            if (context instanceof BaseVocaActivity) {
                ...
                intent.putExtra(Constant.BUNDLE.KEY_OPPONENT_ID, item.getStudentId());
