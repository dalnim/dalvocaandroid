...
public class NativeSpeakerMainAdapter extends RecyclerView.Adapter {

    private static final int TYPE_SERVER_HEADER = 0;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof HeaderHolder) {
            ...
            ((ItemHolder) holder).bind(serverBooks.get(position - 1), listener);
        }
    }

    @Override
    public int getItemCount() {
        return serverBooks.size() + 1;
    }
    ...
    public static class HeaderHolder extends RecyclerView.ViewHolder {
        ...
        public void bind() {
            tvType.setText(R.string.server_wordbooks);
